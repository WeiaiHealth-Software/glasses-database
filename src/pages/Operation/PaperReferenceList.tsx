...
const CATEGORY: 'paper_reference' = 'paper_reference';
...
export default function PaperReferenceListPage() {
  ...
  return (
    <div className="p-8 space-y-6 bg-slate-50/50 min-h-full">
      <SpecCard
        title="论文参考 · 操作规范"
        items={[
          '「论文参考」建议 4~8 条，按录入时间倒序展示在首页；如需人工干预可使用上下移和置顶。',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                placeholder="不超过 60 字，如：离焦镜片 3 年多中心 RCT 分析"
                value={form.title}
                maxLength={60}
            ...
            <div>
              ...
              <Textarea
                rows={2}
                placeholder="首页卡片展示的摘要，100 字内，说明研究目的与核心数据"
                value={form.summary}
                maxLength={100}
            ...
            <div>
              ...
              <Input
                placeholder="如：中华眼科杂志 2024, 60(5): 342-350"
                value={form.source}
                maxLength={40}
